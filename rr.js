...
(function(){
  ...
  var T={
    ...
    pt:{title:"Reservoir Raid — Formação",mine:"⭐ A tua atribuição",phase:"Fase",leader:"Líder",members:"Membros",gn:"Mensagem de grupo",none:"Sem lista fixa — vê a nota.",hold:"Manter os edifícios.",edit:"Editar (R4)",save:"Guardar formação",saved:"✓ guardado e visível para todos",savefail:"Não foi possível guardar (offline ou sem permissões R4).",reset:"Carregar exemplo",addb:"+ Edifício",addm:"+ Membro",free:"— Texto livre —",bname:"Edifício",copy:"📋 Copiar formação",copied:"✓ copiado",onlyr4:"Só o R4 pode editar.",notyou:"Não tens um posto fixo em nenhuma fase — fica no teu edifício atribuído.",ingame:"No jogo alguns nomes aparecem traduzidos:",src:"Estado",cloud:"ao vivo (para todos)",local:"apenas local (não guardado)",core:"Texto de estratégia de exemplo (marcador de posição)."},
