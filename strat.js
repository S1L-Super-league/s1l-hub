...
var STRAT={
  ...
  { id:"res-halten", prio:true, tags:{de:["Halten","Lineup"],en:["Hold","Lineup"],tr:["Tut","Dizilim"],ru:["Удержание","Расстановка"]},
    de:"Reservoir - Halten gewinnt, nicht Toeten!\n#080 Hochwert-Gebaeude halten (Central Reservoir > grosse Komplexe > kleine)\n#080 Nach Gebaeudewert aufstellen, die Staerksten aufs Central Reservoir\n#080 Lieber halten als nur Solo-Wasser jagen",
    en:"Reservoir - holding wins, not killing!\n#080 Hold high-value buildings (Central Reservoir > big complexes > small)\n#080 Line up by value, the strongest on Central Reservoir\n#080 Better to hold than chase solo water",
    tr:"Reservoir - tutmak kazandirir, oldurmek degil!\n#080 Yuksek degerli binalari tut (Central Reservoir > buyuk kompleksler > kucuk)\n#080 Bina degerine gore diziL, en gucluler Central Reservoir'da\n#080 Tek basina su avlamaktansa tutmak daha iyi",
    ru:"Reservoir - удержание побеждает, а не убийство!\n#080 Удерживай ценные здания (Central Reservoir > большие комплексы > мелкие)\n#080 Расставляйся по ценности, сильнейшие на Central Reservoir\n#080 Лучше удерживать, чем гоняться за одиночной водой" },
  { id:"res-aufstellung", prio:false, tags:{de:["Aufstellung"],en:["Line-up"],tr:["Dizilim"],ru:["Расстановка"]},
    de:"Reservoir - Aufstellung je Phase und Gebaeude:\n#080 Unten im Aufstellungs-Block eintragen (Anfuehrer + Mitglieder)\n#080 Dann die fertigen Phasen-Nachrichten kopieren\n#080 Mitglieder sehen die Aufstellung auf der Reservoir-Raid-Eventseite",
    en:"Reservoir - line-up per phase and building:\n#080 Fill it in the line-up block below (leader + members)\n#080 Then copy the ready phase messages\n#080 Members see the line-up on the Reservoir Raid event page",
    tr:"Reservoir - faz ve bina basina dizilim:\n#080 Asagidaki dizilim blogunda doldur (lider + uyeler)\n#080 Sonra hazir faz mesajlarini kopyala\n#080 Uyeler dizilimi Reservoir Raid etkinlik sayfasinda gorur",
    ru:"Reservoir - расстановка по фазам и зданиям:\n#080 Заполни в блоке расстановки ниже (лидер + участники)\n#080 Затем скопируй готовые сообщения по фазам\n#080 Участники видят расстановку на странице события Reservoir Raid" } ],
  stadt:[
