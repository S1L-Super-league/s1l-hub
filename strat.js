  ...
  function rebuild(){
    ...
    Object.keys(DOCS).forEach(function(id){ var d=DOCS[id], ev=d.ev, sid=d.sid; if(!ev||!sid) return;
      ...
      s[ev].push({ id:sid, prio:!!d.prio,
        tags:{ de:[d.name_de||d.name_orig||sid], en:[d.name_en||d.name_orig||sid], fr:[d.name_fr||d.name_orig||sid], it:[d.name_it||d.name_orig||sid], es:[d.name_es||d.name_orig||sid], pt:[d.name_pt||d.name_orig||sid], tr:[d.name_tr||d.name_orig||sid], ru:[d.name_ru||d.name_orig||sid] },
        de:d.t_de||d.t_orig||'', en:d.t_en||'', fr:d.t_fr||'', it:d.t_it||'', es:d.t_es||'', pt:d.t_pt||'', tr:d.t_tr||'', ru:d.t_ru||'' });
    });
